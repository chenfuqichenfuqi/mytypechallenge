...
type JSONSchema2TS<T extends JSONSchema> =
  ...
  T[`type`] extends `array`
    ...
    ? T[`properties`] extends object
      ? CombineObject<
          {
            [P in keyof T[`properties`] as Include<T[`required`], P> extends true
              ? never
              : P]?: JSONSchema2TS<T[`properties`][P]>
          } & {
            [P in keyof T[`properties`] as Include<T[`required`], P> extends true ? P : never]: JSONSchema2TS<
              T[`properties`][P]
            >
          }
        >
    ...
    ? T[`enum`][number]
    : Primitive<T[`type`]>
type test1 = JSONSchema2TS<{
  type: 'number'
  enum: [1, 2, 3]
}>
type test = JSONSchema2TS<{
  type: 'array'
  items: {
    type: 'object'
    properties: {
